create table cards (c_id bigint not null, c_cvv integer, c_exp_date date, c_contactless boolean, c_number varchar(16), c_u_id bigint not null, primary key (c_id));
